...
if __name__ == "__main__":
    ...
    print(wine.shape)
    scattered_points = []
    for k in range(wine.shape[0]):
        scattered_points.append((wine[k][0], wine[k][1]))
            
    args = parser.parse_args()
    orig_filename = "points.png"
    visualize_scatterplot(scattered_points, orig_filename)
    clustered_filename = "points_clustered.png"
